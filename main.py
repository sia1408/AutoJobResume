...
ai.api_key = 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

st.title("Automated Resume Generator with AI")
st.markdown("Cover Letter Generator")
st.sidebar.markdown("We will also use web scraping to fully automate it!")
